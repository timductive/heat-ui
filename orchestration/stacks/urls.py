...
from .views import DetailView, IndexView, LaunchStackView, LaunchHeatView, ResourceView

urlpatterns = patterns('',
    url(r'^$', RedirectView.as_view(url='stacks/'), name='redirect'),
    url(r'^stacks/$', IndexView.as_view(), name='index'),

    url(r'^stacks/launch/new/$', LaunchStackView.as_view(), name='launchnew'),
    url(r'^stacks/launch$', LaunchHeatView.as_view(), name='launch'),
